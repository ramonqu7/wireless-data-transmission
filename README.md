...
-   Here is the [3D Print-ready files](wiki/3d_model/) for the Intel Joule housing box and mount with the End-Effector.

[Intel Joule enclosure body](wiki/3d_model/enclosure_final.STL)

Intel Joule enclosure body

[Intel Joule Box Flat enclosure Top](wiki/3d_model/Top_regular.STL)
...
[Mount cuff connector](wiki/3d_model/ring_final.STL)
